...
CREATE TABLE SOLICITA_DADOS (
    ...
    CONSTRAINT FK2_SOLICITA_DADOS FOREIGN KEY (ID_PESQ) REFERENCES PESQUISADOR(ID) ON DELETE CASCADE
);
...
CREATE TABLE DADOS_AMOSTRA (
    ...
    CONSTRAINT FK_DADOS_AMOSTRA FOREIGN KEY (ID_ESTAB) REFERENCES ESTAB_SAUDE(ID) ON DELETE CASCADE
);
...
CREATE TABLE DISPONIBILIZACAO (
    ...
    CONSTRAINT FK_DISPONIBILIZACAO FOREIGN KEY (ID_DADOS) REFERENCES DADOS_AMOSTRA(ID) ON DELETE CASCADE,
